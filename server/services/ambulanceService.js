...
/**
 * Notify the ambulance service about a new incident report
 * @param {Object} report - The report document
 * @returns {Promise<Object>} - Response from ambulance service
 */
async function notifyAmbulanceService(report) {
  ...
  try {
    const payload = {
      ...
      priority: 'high', // You can implement priority logic based on incident type
      notes: report.notes,
    };
